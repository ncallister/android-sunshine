...
//    cursor.close();
  ...
  public void testGetType()
  {
    ...
    assertEquals(
        "Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry" +
            ".CONTENT_ITEM_TYPE",
  ...
  public void testInsertReadProvider()
  {
    ...
    TestUtilities.validateCursor(
        "testInsertReadProvider.  Error validating joined Weather and Location Data with start " +
            "date.",
        weatherCursor, weatherValues);
    ...
    TestUtilities.validateCursor(
        "testInsertReadProvider.  Error validating joined Weather and Location data for a " +
            "specific date.",
        weatherCursor, weatherValues);
  }
